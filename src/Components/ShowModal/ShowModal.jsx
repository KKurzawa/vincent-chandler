...
const ShowModal = ({ props: { content, setOpenShowsModal } }) => {
    ...
    return (
        <article ref={modalRef} onClick={closeModal} className='shows-modal fixed z-10 flex justify-center items-center inset-0 bg-opacity-10 backdrop-blur-md'>
            <section className='modal-info-container flex flex-col gap-5 w-[90%] h-fit rounded-md'>
                ...
                <article className='shows-modal-message text-center flex flex-col justify-center p-5 md:p-10 '>
