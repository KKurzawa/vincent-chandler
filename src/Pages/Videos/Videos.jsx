...
const Videos = () => {
    return (
        <main className='videos-main flex flex-col justify-center items-center gap-20'>
            <h2 className='videos-title relative top-10 text-6xl lg:text-7xl'>Videos</h2>
            <section className='videos-container-container flex gap-10 lg:gap-20'>
                <article className='videos-container flex flex-col gap-10 lg:gap-20'>
